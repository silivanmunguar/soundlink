 ...
 *
 * @example
 * // Create an instance ofTrackDetailsExtraction
 * const trackDetailsExtraction = newTrackDetailsExtraction();
 *
 * // Set the track ID and authentication token
 * trackDetailsExtraction.trackId = "3Zwu2K0Qa5sT6teZO0Ql3j";
 * trackDetailsExtraction.token = "my-auth-token";
 *
 * // Query the details of the track
 * trackDetailsExtraction.getTrackDetails().then((trackDetails) => {
...
export default TrackDetailsExtraction
